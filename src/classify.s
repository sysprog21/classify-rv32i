...
classify:
    ...
    lw t0, 0(s3)    # t0 = m0_rows
    lw t1, 0(s8)    # t1 = input_cols
    mv a0, t0       # a0 = m0_rows
    mv a1, t1       # a1 = input_cols
    jal multiply    # a0 = m0_rows * input_cols
    slli a0, a0, 2  # a0 = a0 * 4 (size in bytes)
    jal malloc
    beq a0, x0, error_malloc
    ...
    mv a0, s9       # a0 = pointer to h
    lw t0, 0(s3)    # t0 = m0_rows
    lw t1, 0(s8)    # t1 = input_cols
    mv a1, t0       # a1 = m0_rows
    mv a2, t1       # a2 = input_cols
    mv a0, a1       # a0 = m0_rows
    mv a1, a2       # a1 = input_cols
    jal multiply    # a0 = m0_rows * input_cols
    mv a1, a0       # a1 = length of h
    mv a0, s9       # a0 = pointer to h
    jal relu
    ...
    lw t0, 0(s5)    # t0 = m1_rows
    lw t1, 0(s8)    # t1 = input_cols
    mv a0, t0       # a0 = m1_rows
    mv a1, t1       # a1 = input_cols
    jal multiply    # a0 = m1_rows * input_cols
    slli a0, a0, 2  # a0 = a0 * 4 (size in bytes)
    jal malloc
    beq a0, x0, error_malloc
    ...
    mv a1, a2       # a1 = input_cols
    jal multiply    # a0 = m1_rows * input_cols
    mv a1, a0       # a1 = length of o
    mv a0, s10      # a0 = pointer to o
    jal argmax
